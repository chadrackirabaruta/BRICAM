...
<main id="main" class="main">
  <div class="pagetitle">
    <h1><i class="bi bi-person-plus"></i> Create New Employee</h1>
  </div>
  ...
  <section class="section">
    <div class="card">
      <div class="card-body pt-4">
        <h5 class="card-title text-primary"><i class="bi bi-pencil-square"></i> Employee Registration</h5>
        ...
        <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row g-3">
            ...
            <!-- ID Number -->
            <div class="col-md-6">
              <label for="id_number" class="form-label"><i class="bi bi-person-badge"></i> ID Number <span class="text-danger">*</span></label>
              <div class="input-group has-validation position-relative">
                <input type="text" name="id_number" id="id_number" class="form-control" maxlength="16" required>
            ...
            <!-- Birth Date -->
            <div class="col-md-6">
              <label for="dob" class="form-label"><i class="bi bi-calendar2-day"></i> Date of Birth <span class="text-danger">*</span></label>
              <input type="date" name="dob" id="dob" class="form-control" required>
            </div>

            <!-- Gender -->
            <div class="col-md-6">
              <label class="form-label d-block"><i class="bi bi-gender-ambiguous"></i> Gender <span class="text-danger">*</span></label>
            ...
            <!-- Employee Type -->
            <div class="col-md-6">
              <label for="employee_type_id" class="form-label"><i class="bi bi-briefcase"></i> Employee Type <span class="text-danger">*</span></label>
            ...
            <!-- Salary Type -->
            <div class="col-md-6">
              <label for="salary_type_id" class="form-label"><i class="bi bi-cash-stack"></i> Salary Type <span class="text-danger">*</span></label>
      ...
      <select id="village" name="village" class="form-select" required>
        <option value="">-- Hitamo Umudugudu --</option>
          ...
          <div class="text-end mt-4">
            ...
            <button type="submit" class="btn btn-success"><i class="bi bi-check-circle"></i> Create Employee</button>
          </div>
        </form>
      </div>
    </div>
  ...
  fetch('/api/locations/provinces')
    ...
    .then(data => {
      ...
      data.forEach(prov => {
        ...
        // Create option element for each province
